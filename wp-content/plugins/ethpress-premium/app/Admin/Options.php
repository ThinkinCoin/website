...
class Options
{
    ...
    public static function create_page()
    {
        ...
        $possible_screens = array('default' => esc_html(__('Standard', 'ethpress')));
        ...
        if (isset($_POST['Submit'])) {
            ...
            if (empty($new_options['recursive']) && is_multisite()) {
                ...
                if (false !== get_option('ethpress')) {
                    ...
                    $deprecated = '';
                    $autoload = 'no';
                    add_option('ethpress', $new_options, $deprecated, $autoload);
                }
            }

?>
            <div class="updated">
                <p><?php _e('Settings saved.', 'ethpress'); ?></p>
            </div>
        <?php
        ...
        <div class="wrap">
            ...
            if (\losnappas\Ethpress\ethpress_fs()->is_not_paying()) {
                ...
                echo ' <a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' .
                    esc_html__('Upgrade Now!', 'ethpress') .
                    '</a>';
                echo '</section>';
            }
            ?>
            ...
            <h2 class="nav-tab-wrapper">
                ...
                ?>
                    <a href="<?php echo $admin_url; ?>" class="nav-tab<?php if ($s == $current_screen) echo ' nav-tab-active'; ?>"><?php echo esc_html($sTitle); ?></a>
                <?php
                }
                ?>
            </h2>
            ...
            <form id="ethpress_admin_form" method="POST" action="">
                ...
                <?php wp_nonce_field('ethpress-update-options'); ?>
                ...
                ?>
                <p class="submit">
                    <input class="button-primary" type="submit" name="Submit" value="<?php _e('Save Changes', 'ethpress') ?>" />
                    <input id="ETHPRESS_reset_options" type="submit" name="Reset" onclick="return confirm('<?php _e('Are you sure you want to delete all EthPress options?', 'ethpress') ?>')" value="<?php _e('Reset', 'ethpress') ?>" />
                </p>
                <?php
                // }
                ?>
    ...
    ?>
        <tr valign="top">
            <th scope="row" colspan="2">
                <h2>
                    <?php _e("WooCommerce Settings", 'ethpress'); ?>
                </h2>
            </th>
            <td>
            </td>
    ...
    ?>
        <tr valign="top">
            <th scope="row" colspan="2">
                <h2>
                    <?php _e("WalletConnect Settings", 'ethpress'); ?>
                </h2>
            </th>
            <td>
            </td>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("WalletConnect Project ID", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input class="regular-text" id="ethpress_project_Id" name="ethpress[wallet_connect_project_id]" type="text" placeholder="<?php echo esc_attr(__("WalletConnect Project ID", 'ethpress')) ?>" value="<?php echo esc_attr(isset($options['wallet_connect_project_id']) ? esc_attr($options['wallet_connect_project_id']) : '')  ?>">
                        <p class="description">
                            <?php echo sprintf(
    ...
    ?>
        <tr valign="top">
            <th scope="row" colspan="2">
                <h2>
                    <?php _e("Web3 Login Form", 'ethpress'); ?>
                </h2>
            </th>
            <td>
            </td>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Theme Mode", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input class="regular-text" id="ethpress_theme_mode_dark" name="ethpress[theme_mode]" type="radio" value="dark" <?php echo ($ethpress_theme_mode == "dark" ? 'checked' : '') ?>>
                        <label for="ethpress_theme_mode_dark"><?php _e("Dark Mode", 'ethpress'); ?></label>
                        <input class="regular-text" id="ethpress_theme_mode_lite" name="ethpress[theme_mode]" type="radio" value="light" <?php echo ($ethpress_theme_mode == "light" ? 'checked' : '') ?>>
                        <label for="ethpress_theme_mode_lite"><?php _e("Light Mode", 'ethpress'); ?></label>
                    </label>
                </fieldset>
            </td>
        </tr>
    ...
    ?>
        <tr valign="top">
            <th scope="row" colspan="2">
                <h2>
                    <?php _e("Strings Settings", 'ethpress'); ?>
                </h2>
            </th>
            <td>
            </td>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Login button label", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_login_button_label" name="ethpress[login_button_label]" type="text" placeholder="<?php echo esc_attr($login_button_label) ?>" value="<?php echo esc_attr(isset($options['login_button_label']) ? esc_attr($options['login_button_label']) : '') ?>">
                        <p class="description">
                            <?php _e('The Login button text can be set there.', 'ethpress') ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
                        ?>
                            <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to keep using this feature!', 'ethpress') . '</a>'; ?></h2>
                        <?php
                        } else if ('disabled' === $disabled) {
                        ?>
                            <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to use this feature!', 'ethpress') . '</a>'; ?></h2>
                        <?php
                        }
                        ?>
                    </label>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Link button label", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_link_button_label" name="ethpress[link_button_label]" type="text" placeholder="<?php echo esc_attr($link_button_label) ?>" value="<?php echo esc_attr(isset($options['link_button_label']) ? esc_attr($options['link_button_label']) : '') ?>">
                        <p class="description">
                            <?php _e('The Link button text can be set there.', 'ethpress') ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
                        ?>
                            <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to keep using this feature!', 'ethpress') . '</a>'; ?></h2>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Register button label", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_register_button_label" name="ethpress[register_button_label]" type="text" placeholder="<?php echo esc_attr($register_button_label) ?>" value="<?php echo esc_attr(isset($options['register_button_label']) ? esc_attr($options['register_button_label']) : '') ?>">
                        <p class="description">
                            <?php _e('The Register button text can be set there.', 'ethpress') ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
                        ?>
                            <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to keep using this feature!', 'ethpress') . '</a>'; ?></h2>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("The account link success message", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_link_message" name="ethpress[link_message]" type="text" placeholder="<?php echo esc_attr($link_message) ?>" value="<?php echo esc_attr(isset($options['link_message']) ? esc_attr($options['link_message']) : '') ?>">
                        <p class="description">
                            <?php _e('The successful account link message. The %s can be used to insert the account address linked.', 'ethpress') ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
                        ?>
                            <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to keep using this feature!', 'ethpress') . '</a>'; ?></h2>
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Verification Service API URL", 'ethpress'); ?></th>
            <td>
                <?php
                if ($ecrecovers_with_php) {
                ?>
                    <p class="description">
                        <?php esc_html_e('Your PHP installation has the necessary PHP extension to do verifications on your server, so there is nothing to configure.', 'ethpress') ?>
                    </p>
                <?php
                } else {
                ?>
                    <fieldset>
                        <label>
                            <input class="regular-text" id="ethpress_api_url" name="ethpress[api_url]" type="text" value="<?php echo esc_attr($api_url) ?>">
                            <p class="description">
                                <?php echo wp_kses(
                                    sprintf(
                                        __(
                                            'Use an API or install %1$sPHP-GMP%2$s or %3$sPHP-BCMath%2$s to verify Ethereum signatures.',
                                            'ethpress'
                                        ),
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Redirect URL", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <label>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_redirect_url" name="ethpress[redirect_url]" type="text" value="<?php echo esc_attr($redirect_url) ?>">
                        <p class="description">
                            <?php _e(
                                'The page to redirect after a successful login',
                                'ethpress'
                            ) ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
    ...
    public static function input_use_managed_service($options = null)
    {
        ...
        $disabled = 'disabled';
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            $use_managed_service = isset($options['use_managed_service']) ? boolval($options['use_managed_service']) : false;
            $disabled = '';
        }
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("Managed Verification Service", 'ethpress'); ?></th>
            <td>
                <?php
                if ($ecrecovers_with_php) {
                ?>
                ...
                ?>
                    <fieldset>
                        <input <?php echo $disabled ?> class="regular-text" id="ethpress_use_managed_service" name="ethpress[use_managed_service]" type="checkbox" value="yes" <?php echo ($use_managed_service ? 'checked' : '') ?>>
                        <label for="ethpress_use_managed_service">
                            <?php _e('Use Managed Verification Service', 'ethpress') ?>
                        </label>
                        <p class="description">
                            <?php _e(
                                'Check to use the Managed Verification Service.',
                                'ethpress'
                            ) ?></p>
                        <?php
                        if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
    ...
    public static function woocommerce_login_form_setting($options = null)
    {
        ...
        $disabled = 'disabled';
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            $woocommerce_login_form_show = isset($options['woocommerce_login_form_show']) ? boolval($options['woocommerce_login_form_show']) : false;
    ...
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("WooCommerce Login Form", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <input <?php echo $disabled ?> class="regular-text" id="ethpress_woocommerce_login_form_show" name="ethpress[woocommerce_login_form_show]" type="checkbox" value="yes" <?php echo ($woocommerce_login_form_show ? 'checked' : '') ?> />
                    <label for="ethpress_woocommerce_login_form_show">
                        <?php _e('Show on WooCommerce Login Form?', 'ethpress') ?>
                    </label>
                    <p class="description">
                        <?php _e(
                            'Check to show EthPress login button on the WooCommerce Login Form.',
                            'ethpress'
                        ) ?></p>
                    <?php
                    if (\losnappas\Ethpress\ethpress_fs()->is_trial()) {
                    ?>
                        <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to keep using this feature!', 'ethpress') . '</a>'; ?></h2>
                    <?php
                    } else if (!\losnappas\Ethpress\ethpress_fs()->can_use_premium_code()) {
                    ?>
                        <h2 class="description"><?php echo '<a href="' . \losnappas\Ethpress\ethpress_fs()->get_upgrade_url() . '">' . __('Upgrade to use this feature!', 'ethpress') . '</a>'; ?></h2>
                    <?php
                    }
                    if (!$woocommerce_active) {
                    ?>
                        <h2 class="description"><?php echo '<a href="https://woocommerce.com/?aff=12943&cid=17113767">' . __('Install WooCommerce to use this feature!', 'ethpress') . '</a> ' . __('WooCommerce is a customizable, open-source eCommerce platform built on WordPress.', 'ethpress'); ?></h2>
                    <?php
                    }
                    ?>
                </fieldset>
    ...
    public static function woocommerce_register_form_setting($options = null)
    {
        ...
        $disabled = 'disabled';
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            $woocommerce_register_form_show = isset($options['woocommerce_register_form_show']) ? boolval($options['woocommerce_register_form_show']) : false;
            if (get_option('users_can_register') && $woocommerce_active) {
                $disabled = '';
            }
        }
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("WooCommerce Register Form", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <input <?php echo $disabled ?> class="regular-text" id="ethpress_woocommerce_register_form_show" name="ethpress[woocommerce_register_form_show]" type="checkbox" value="yes" <?php echo ($woocommerce_register_form_show ? 'checked' : '') ?> />
                    <label for="ethpress_woocommerce_register_form_show">
                        <?php _e('Show on WooCommerce Register Form?', 'ethpress') ?>
                    </label>
                    <p class="description">
                        <?php _e(
                    ...
                    ?>
                        <h2 class="description"><?php echo '<a href="' . get_admin_url() . 'options-general.php' . '">' . __('Check the Administration > Settings > General > Membership: Anyone can register box to use this feature.', 'ethpress') . '</a> '; ?></h2>
                    <?php
                    }
                    ?>
                </fieldset>
    ...
    public static function woocommerce_after_checkout_registration_form_setting($options = null)
    {
        ...
        $disabled = 'disabled';
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            $woocommerce_after_checkout_registration_form_show = isset($options['woocommerce_after_checkout_registration_form_show']) ? boolval($options['woocommerce_after_checkout_registration_form_show']) : false;
            if (get_option('users_can_register') && $woocommerce_active) {
                $disabled = '';
            }
        }
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("WooCommerce Checkout Page Register Form", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <input <?php echo $disabled ?> class="regular-text" id="ethpress_woocommerce_after_checkout_registration_form_show" name="ethpress[woocommerce_after_checkout_registration_form_show]" type="checkbox" value="yes" <?php echo ($woocommerce_after_checkout_registration_form_show ? 'checked' : '') ?> />
                    <label for="ethpress_woocommerce_after_checkout_registration_form_show">
                        <?php _e('Show on the WooCommerce Checkout page?', 'ethpress') ?>
                    </label>
                    <p class="description">
                        <?php _e(
    ...
    public static function woocommerce_account_details_link_button_setting($options = null)
    {
        ...
        $disabled = 'disabled';
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            $woocommerce_account_details_link_button_show = isset($options['woocommerce_account_details_link_button_show']) ? boolval($options['woocommerce_account_details_link_button_show']) : false;
            if ($woocommerce_active) {
                $disabled = '';
            }
        }
    ?>
        <tr valign="top">
            <th scope="row"><?php _e("WooCommerce Account Details Link Wallet Form", 'ethpress'); ?></th>
            <td>
                <fieldset>
                    <input <?php echo $disabled ?> class="regular-text" id="ethpress_woocommerce_account_details_link_button_show" name="ethpress[woocommerce_account_details_link_button_show]" type="checkbox" value="yes" <?php echo ($woocommerce_account_details_link_button_show ? 'checked' : '') ?> />
                    <label for="ethpress_woocommerce_account_details_link_button_show">
                        <?php _e('Show the Link Wallet button on the WooCommerce Account Details page?', 'ethpress') ?>
                    </label>
                    <p class="description">
                        <?php _e(
...
<?php
    ...
    public static function options_validate($input, $options, $current_screen)
    {
        ...
        if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
            // ... premium only logic ...
            $use_managed_service = boolval(esc_attr(trim($input['use_managed_service'])));
            $woocommerce_login_form_show = boolval(esc_attr(trim($input['woocommerce_login_form_show'])));
            $woocommerce_register_form_show = boolval(esc_attr(trim($input['woocommerce_register_form_show'])));
            $woocommerce_after_checkout_registration_form_show = boolval(esc_attr(trim($input['woocommerce_after_checkout_registration_form_show'])));
            $woocommerce_account_details_link_button_show = boolval(esc_attr(trim($input['woocommerce_account_details_link_button_show'])));
            $login_button_label = sanitize_text_field(trim($input['login_button_label']));
            $link_button_label = sanitize_text_field(trim($input['link_button_label']));
            $register_button_label = sanitize_text_field(trim($input['register_button_label']));
            $link_message = sanitize_text_field(trim($input['link_message']));
            $redirect_url  = esc_url_raw(trim($input['redirect_url']));
        }
