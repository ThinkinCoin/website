...
define('CPMW_VERSION', '1.2.8');
define('CPMW_FILE', __FILE__);
define('CPMW_PATH', plugin_dir_path(CPMW_FILE));
define('CPMW_URL', plugin_dir_url(CPMW_FILE));

define('CPMW_BUY_PRO',"https://coolplugins.net/product/pay-with-metamask-for-woocommerce-pro/?utm_source=cpmw_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=widget_settings");
if(!defined('CPMW_DEMO_URL')){
    define('CPMW_DEMO_URL',"https://cryptocurrencyplugins.com/plugin/pay-with-metamask-for-woocommerce/?utm_source=cpmw_plugin&utm_medium=inside&utm_campaign=demo&utm_content=widget_settings");
}
