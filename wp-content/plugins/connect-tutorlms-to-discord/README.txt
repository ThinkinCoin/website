...
Tags: Discord, Talk, Video Chat, Hang Out, Friends, Memberships, discord role management, lms, TutorLMS, learning community management.
...
== Description ==
This add-on enables connecting your TutorLMS-enabled website to your discord server. With this plugin, you can create a discord community of your students and assign them discord roles in the server according to the course they are learning.
...
Connect Tutor LMS to Discord Plugin Features:
1) Allow any student to connect their discord account with their Tutor LMS website account.

2) Shortcode [tutor_lms_discord] to display connect/disconnect button.
...
7) Send custom message when student enrolls in course.

== Installation ==

= Download, Install and Activate! =
1. Go to Plugins > Add New to find and install connect Tutor LMS to Discord Addon.
...
14. [Connect LifterLMS and Discord](https://wordpress.org/plugins/connect-lifterlms-to-discord/)
...
== Screenshots ==
1. Install and activate the plugin and view the "Discord Settings" menu inside Tutor LMS LMS.
2. Map Discord roles and Tutor LMS Course.
3. Advanced settings.
