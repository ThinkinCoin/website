...
[youtube https://www.youtube.com/watch?v=U5AkEH57BXA]
...
[Tutor LMS](https://wordpress.org/plugins/tutor/) is a completely free WordPress LMS plugin that simplifies complex course creation processes. You can create courses and extend its ability to teach students by adding quizzes. myCred Tutor LMS add-on combines myCred’s reward management system with courses and quizzes to engage, encourage and excite users.
...
= Documentation =
[Click Here](https://codex.mycred.me/chapter-iii/freebies/mycred-tutor-lms/) to read complete documentation of the product. The documentation includes a step-by-step installation and configuration guide, system specifications, troubleshooting, and support.
