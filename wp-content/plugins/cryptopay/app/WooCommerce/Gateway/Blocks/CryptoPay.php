...
namespace BeycanPress\CryptoPay\WooCommerce\Gateway\Blocks;

// @phpcs:disable PSR1.Methods.CamelCapsMethodName.NotCamelCaps

use BeycanPress\CryptoPay\Helpers;
use BeycanPress\CryptoPay\WooCommerce\Gateway as WCCryptoPay;
...
class CryptoPay extends AbstractPaymentMethodType
{
    ...
    public function get_payment_method_data(): array
    {
        return [
            ...
            'content'  => $this->get_setting('description'), // TODO: will update for pay on checkout
