        ...
        Settings::createSection(array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'desc'    => esc_html__('This field is the public EVM address field. As you know, when you create a MetaMask or Trust Wallet wallet, your wallet address is the same on all networks. Therefore, you only need to enter a single address here. However, you can define it at a different address for each network.', 'cryptopay'),
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type'    => 'switcher',
                            'default' => true,
                            'desc'    => esc_html__('Binance Wallet is only available on (BNB Smart Chain and Ethereum Mainnet).', 'cryptopay') . CP_BR2 . esc_html__('DEPRECATED: Binance Wallet is no longer supported because merged with Trust Wallet. But you can still use if you want.', 'cryptopay'),
                        ),
                        array(
                            'id'      => 'phantom',
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            ...
                            'id'    => 'rpcUrl',
                            'type'  => 'text',
                            'desc'   => esc_html__('A Node API address where we can control transactions on the blockchain. Sometimes public APIs can restrict you. Therefore you may need a custom API address.', 'cryptopay') . ' <a href="https://beycanpress.gitbook.io/cryptopay-docs/network-support-add-ons/blockchain-node-providers#what-are-rpc-url" target="_blank">What are Custom RPC URL?</a>'
                        ),
                        array(
                            'title' => esc_html__('Websocket URL', 'cryptopay'),
                            'id'    => 'wsUrl',
                            'type'  => 'text',
                            'desc' => esc_html__('If you want to enable QR payments on this network, please provide a Websocket URL.', 'cryptopay') . ' <a href="https://beycanpress.gitbook.io/cryptopay-docs/network-support-add-ons/blockchain-node-providers#what-are-websocket-url" target="_blank">What are Websocket URL?</a>',
                        ),
                        array(
                        ...
                        array(
                            ...
                            'id'    => 'web3Domain',
                            'type'  => 'text',
                            'desc'  => esc_html__('There is no obligation to fill in this field. If you have a domain, for example, you can enter "beycanpress.eth" in this field. However, please make sure that this domain matches the general address or the address you will enter below.', 'cryptopay')
                        ),
                        array(
                            'title' => esc_html__('Wallet Address', 'cryptopay'),
                            'id'    => 'walletAddress',
                            'type'  => 'text',
                            'desc'  => esc_html__('This field is not required. If you have already entered a general wallet address, you do not need to enter anything here. However, if you want to receive payments to a different wallet address for this network, you can enter it.', 'cryptopay')
                        ),
                        array(
                            'id'      => 'active',
                            'title'   => esc_html__('Active/Passive', 'cryptopay'),
                        ...
                        array(
                            ...
                            'id'    => 'image',
                            'type'  => 'upload',
                            'desc'    => esc_html__('You can upload an custom image for this network. If you\'r not choose any image app will use default image.', 'cryptopay'),
                        ),
                        array(
                            'id'     => 'nativeCurrency',
                            'type'   => 'fieldset',
