...
use BeycanPress\CryptoPay\Settings\EvmChains;
use BeycanPress\CryptoPay\Models\OrderTransaction;
use BeycanPress\CryptoPay\Models\AbstractTransaction;
use BeycanPress\CryptoPay\PluginHero\Helpers as PhHelpers;
// Types
...
// Exceptions
use BeycanPress\CryptoPay\Exceptions\IntegrationRegistryException;
...
class Helpers extends PhHelpers
{
    ...
    {
        // @phpcs:ignore
        self::adminNotice(str_replace('{networkName}', $networkName, esc_html__('You did not specify a wallet address in the "CryptoPay {networkName} settings", {networkName} network will not work. Please specify a wallet address first.', 'cryptopay')), 'error');
    }
}
