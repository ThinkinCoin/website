    ...
    <nav class="navbar <?php echo tutorstarter_header_switcher(); ?> <?php echo 'navbar-right' === tutorstarter_header_switcher() ? 'has-search-field' : ''; ?>">
        ...
        <div class="navbar-utils">
			...
			<div class="user_revenue">
				<div class="token-icon"><span><img src="https://thinkincoin.com/website/wp-content/uploads/2023/07/neurons.png"></span></div>
				<div class="income-display">
				<span class="revenue-title">Your revenue:</span>
				<span class="ballance"><?php $content = '[mycred_my_balance wrapper=0 title_el="" balance_el=""]';
echo do_shortcode($content);?></span>
				<div class="utils-btn">
