...
<?php do_action( 'educator_education_page_header' ); ?>

<main role="main" id="maincontent" class="py-5">
    <div class="container">
        <?php
        $educator_education_left_right = get_theme_mod( 'educator_education_single_page_sidebar_layout','One Column');
        if($educator_education_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 left-sidebar-page background-img-skin">
                    <?php if (get_theme_mod('educator_education_single_page_breadcrumb',true) != ''){ ?>
                        <div class="bradcrumbs">
                            <?php educator_education_the_breadcrumb(); ?>
                        </div>
                    <?php }?>
...
<?php do_action( 'educator_education_page_footer' ); ?>
