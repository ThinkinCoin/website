...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function online_tutor_customizer_label( id, title ) {
			...
			if ( id === 'online_tutor_preloader_hide' || id === 'online_tutor_sticky_header' || id === 'online_tutor_scroll_hide' ) {
			...
			if ( id === 'online_tutor_ticket_text' || id === 'tutor_academy_admission' || id === 'tutor_academy_research' || id === 'tutor_academy_faq' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		online_tutor_customizer_label( 'tutor_academy_admission', 'Addmission' );
		online_tutor_customizer_label( 'tutor_academy_research', 'Research' );
		online_tutor_customizer_label( 'tutor_academy_faq', 'FAQs' );
